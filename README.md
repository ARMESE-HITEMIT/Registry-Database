...
| ------------------------------ | --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `ankerl::unordered_dense::map` | Third-party library     | High-performance hash map used for fast key-based lookup and in-memory indexing of registry data, client/session information, subscriptions, and other internal structures where hash-based access is beneficial. | Integrated directly into the C++ implementation; used as an internal container and is not intended to define the public registry data format. |
