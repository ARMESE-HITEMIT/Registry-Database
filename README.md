...
* Software License:
  ...
  SCAN CODE:
![software_license_scancode](Program Datas/Resources/Documents/software_license_scancode.png)
------------------------------------------------------------------------------------------------------------------
* License Agreement - Global Version:
  ...
  SCAN CODE:
![license_scancode](Program Datas/Resources/Documents/license_scancode.png)