...
| Dependency                     | Type                        | Author / Maintainer                                   | License                  | Repository / Reference                                | Purpose / Usage                                                                                                                                                                                                   | Integration                                                                                                                                   |
| ------------------------------ | --------------------------- | ----------------------------------------------------- | ------------------------ | ----------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `ankerl::unordered_dense::map` | External library            | Martin Leitner-Ankerl                                 | MIT License              | [GitHub](https://github.com/martinus/unordered_dense) | High-performance hash map used for fast key-based lookup and in-memory indexing of registry data, client/session information, subscriptions, and other internal structures where hash-based access is beneficial. | Integrated directly into the C++ implementation; used as an internal container and is not intended to define the public registry data format. |
| `system.h`                     | Internal library            | Hitemit-Armese                             | Project-defined          | Internal project source                               | Provides system-level functionality required by the project, such as platform-specific operations and low-level runtime facilities used by the Registry Database implementation.                                  | Internal project dependency; may be updated together with the main codebase.                                                                  |
| `utilityX.h`                   | Internal library            | Hitemit-Armese                             | Project-defined          | Internal project source                               | Provides common low-level utilities and supporting functionality used throughout the implementation, including internal helpers required by the Registry Database components.                                     | Internal project dependency; version changes may occur together with the main project.                                                        |
| C++ Standard Library           | Standard library            | C++ standardization community / implementation vendor | Implementation-dependent | [ISO C++](https://isocpp.org/)                        | Provides fundamental language/runtime facilities, containers, synchronization primitives, strings, exceptions, and other standard functionality required by the implementation.                                   | Required by the C++ build environment.                                                                                                        |
| TCP/IP Socket API              | System / platform interface | Platform / OS vendor                                  | Platform-dependent       | Operating-system documentation                        | Provides the communication transport between the Registry Database Host Service and connected clients or local services.                                                                                          | Platform-dependent implementation behind the communication layer.                                                                             |
